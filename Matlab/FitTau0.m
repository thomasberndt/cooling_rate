function [tau0, total_err] = FitTau0(Tc, tau0s, TA, rA, TD, rD, eta)
    ...
    [~      , rA_g] = meshgrid(tau0s, rA); 
    [~      , eta_g] = meshgrid(tau0s, eta); 
    
    tD_g = EffectiveTime(TD_g, rD_g, tau0s_g, Tc); 
    tA_g = EffectiveTimeField(TA_g, rA_g, tau0s_g, Tc, eta_g); 
    ...
    tau0 = tau0s(total_err==min(total_err));
